...
export const gameRewards: GameReward[] = [
  ...
  { id: 'r2', rewardKey: 'redsea-1-c1', activityId: 'red-sea', companyId: 'c1', title: 'Premio especial', reason: 'Cruza el Mar Rojo · 1.º mejor tiempo', status: 'READY' },
...
export const tournamentMatches = [
  { id: 'm1', round: 'Cuartos', companyAId: 'c1', companyBId: 'c8', winnerCompanyId: 'c1', status: 'FINISHED' },
  { id: 'm2', round: 'Cuartos', companyAId: 'c4', companyBId: 'c5', winnerCompanyId: 'c4', status: 'FINISHED' },
  { id: 'm3', round: 'Cuartos', companyAId: 'c2', companyBId: 'c7', winnerCompanyId: 'c2', status: 'FINISHED' },
  { id: 'm4', round: 'Cuartos', companyAId: 'c3', companyBId: 'c6', status: 'LIVE' },
  { id: 'm5', round: 'Semifinal', companyAId: 'c1', companyBId: 'c4', winnerCompanyId: 'c1', status: 'FINISHED' },
