...
export const scheduleItems: ScheduleItem[] = [
  ...
  { id: 'rotation-3', startTime: '13:00', endTime: '14:00', title: 'Ronda 3 · Rotación final', description: 'Última rotación: las 12 compañías completan las tres actividades.', icon: 'rotation', kind: 'activity', rotations: [{ title: 'Escape del Desierto', companies: 'Compañías 1 · 2 · 3 · 4', icon: 'desert' }, { title: 'Evita las Plagas', companies: 'Compañías 5 · 6 · 7 · 8', icon: 'plagues' }, { title: 'Cruza el Mar Rojo', companies: 'Compañías 9 · 10 · 11 · 12', icon: 'red-sea' }] },
